...
export const portfolio = {
  ru: {
    ...
    intro:
      "Создаю веб-продукты на стыке надёжного backend и понятного интерфейса. Люблю превращать сложные процессы в простые рабочие инструменты.",
    ...
    contactText: "Открыт к сотрудничеству и интересным инженерным задачам.",
    contactButton: "Написать в GitHub",
  ...
  en: {
    ...
    contactText: "Open to collaboration and interesting engineering work.",
